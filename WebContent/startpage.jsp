...
<body>
			...
			<div id="logo">
				<c:choose>
					<c:when test="${isAuthorized == 0}">
						<p>
							<a href="javascript:PopUpShow()">Log In via telegram</a>
						</p>
					</c:when>
					<c:otherwise>
			...
			<div class="container">
				...
				<c:choose>
					<c:when test="${isAuthorized == 0}">
						...
						<header>
							<h2 class="alt">
								<strong>VkFilesBot</strong><br /> To watch your bot history,
								please, log in. <br />
							</h2>
						</header>

						<footer>
							<a href="javascript:PopUpShow()" class="button scrolly">Log
								in via Telegram</a>
						</footer>
					...
					<c:otherwise>
						<header>
							<h2 class="alt">
								Hello, <strong>${username}</strong>!<br /> Now, you can see
								your requests to the bot.<br />
							</h2>
						</header>
	...
	<div class="b-popup" id="popup1">
		<div class="b-popup-content">
			...
			<hr />
			To sign in, follow these steps: <br /> 1. Go to <u><a href="https://telegram.me/VkFiles_Bot?start=${sessionId}" target="_blank"> this link</a></u> into your conversation with our bot.
			<br /> 2. Press "Start" button <br /> 3. Close this window or <u><a	href="">refresh this page.</a></u>
		</div>
	</div>
